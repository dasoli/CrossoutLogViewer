...
namespace CrossoutLogView.Common
{
    public static class DateTimeExtention
    {
        ...
        ///     The <see cref="DayOfWeek" /> that counts as the first. Default is
        ...
        /// </summary>
        /// <param name="dt">The <see cref="DateTime" /> used to determine to week.</param>
        /// <param name="endOfWeek">
        ///     The <see cref="DayOfWeek" /> that counts as the last. Default is
        ///     <see cref="DayOfWeek.Sunday" />.
        /// </param>
        ...
        public static DateTime EndOfWeek(this DateTime dt, DayOfWeek endOfWeek = DayOfWeek.Sunday)
        {
            ...
            var diff = (endOfWeek - dt.DayOfWeek).NonNegModulus(7) + 1;
