...
namespace CrossoutLogView.Common
{
    public static class PathUtility
    {
        ...
        /// <summary>
        ///     Normalizes a path by resolving URL encoding, removing tailing and unifing directoryseparators, and resolving the
        ///     absolute path.
        /// </summary>
        /// <param name="path">The path of a file or directory.</param>
        ...
        /// <summary>
        ///     Returns the name of the files parent directory, if the <paramref name="path" /> is a file; otherwise the name of
        ///     the directory without a path.
        /// </summary>
        /// <param name="path">The path of a file or directory.</param>
        /// <returns>
        ///     The name of the files parent directory, if the <paramref name="path" /> is a file; otherwise the name of the
        ///     directory without a path.
        /// </returns>
        ...
        /// <summary>
        ///     Returns the name and the extention of the file, separated by a dot. If the <paramref name="path" /> is a directory
        ///     instead of a file, return <see cref="null" />.
        /// </summary>
        /// <param name="path">The path of a file or directory.</param>
        /// <returns>
        ///     The name and the extention of the file, separated by a dot. If the <paramref name="path" /> is a directory
        ///     instead of a file, return <see cref="null" />.
        /// </returns>
        ...
        /// <summary>
        ///     Parses the <paramref name="directoryName" /> to <see cref="DateTime" /> using the format yyyy.MM.dd HH.mm.ss with
        ///     local time.
        /// </summary>
        /// <param name="directoryName">Name of the directory.</param>
        /// <param name="dateTime">The <see cref="DateTime" /> derived from the <paramref name="directoryName" />.</param>
        /// <returns>
        ///     <see cref="true" /> if the <paramref name="directoryName" /> conforms with the format; otherwise
        ///     <see cref="false" />.
        /// </returns>
        public static bool TryParseCrossoutLogDirectoryName(string directoryName, out DateTime dateTime)
        {
            return DateTime.TryParseExact(directoryName, "yyyy.MM.dd HH.mm.ss", CultureInfo.InvariantCulture,
        ...
        {
            return DateTime.ParseExact(directoryName, "yyyy.MM.dd HH.mm.ss", CultureInfo.InvariantCulture,
