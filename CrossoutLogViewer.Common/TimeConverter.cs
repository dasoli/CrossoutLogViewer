...
namespace CrossoutLogView.Common
{
    public static class TimeConverter
    {
        ...
        ///     The <see cref="String" /> containing the hour, minute, second and millisecond data of the
        ///     line.
        /// </param>
        ...
        public static long FromString(ReadOnlySpan<char> lineTimeStamp, DateTime logDate)
        {
            ...
            int.TryParse(lineTimeStamp[..2], NumberStyles.Integer, CultureInfo.InvariantCulture.NumberFormat, out hour);
            int.TryParse(lineTimeStamp[3..5], NumberStyles.Integer, CultureInfo.InvariantCulture.NumberFormat,
                out minute);
            int.TryParse(lineTimeStamp[6..8], NumberStyles.Integer, CultureInfo.InvariantCulture.NumberFormat,
                out second);
            int.TryParse(lineTimeStamp[9..12], NumberStyles.Integer, CultureInfo.InvariantCulture.NumberFormat,
                out millisecond);
