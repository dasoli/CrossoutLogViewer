...
namespace CrossoutLogView.Database.Data
{
    public class Settings
    {
        ...
        {
            get => _logRootPath;
            set => Set(ref _logRootPath, value);
        }
        ...
        public LogConfig LogConfiguration
        {
            ...
            set => Set(ref _logConfiguration, value);
        }
        ...
        public long StatisticsParseDateTime
        {
            ...
            set => Set(ref _statitisticsParseDate, value);
        }
        ...
        public string BaseColorScheme
        {
            ...
            set => Set(ref _baseColorScheme, value);
        }
        ...
        {
            get => _teamWonColor;
            set => Set(ref _teamWonColor, value);
        }
        ...
        {
            get => _teamLostColor;
            set => Set(ref _teamLostColor, value);
        }
        ...
        public string TotalDamage
        {
            ...
            set => Set(ref _totalDamageColor, value);
        }
        ...
        public string CriticalDamage
        {
            ...
            set => Set(ref _criticalDamageColor, value);
        }
        ...
        public string ArmorDamage
        {
            ...
            set => Set(ref _armorDamageColor, value);
        }
        ...
        {
            get => _suicideColor;
            set => Set(ref _suicideColor, value);
        }
        ...
        {
            get => _despawnColor;
            set => Set(ref _despawnColor, value);
        }
        ...
        public bool StartupMaximized
        {
            get => _startupMaximized;
            set => Set(ref _startupMaximized, value);
        }
        ...
        public static Settings ReadInstance()
        {
            ...
            if (!File.Exists(Strings.DataBaseCurrentSettingsPath)) Update();
                ...
                Current = JsonConvert.DeserializeObject<Settings>(
                    File.ReadAllText(Strings.DataBaseCurrentSettingsPath));
            lockWrite = false;
            return Current;
        }
        ...
        public static void WriteInstance()
        {
            ...
            File.WriteAllText(Strings.DataBaseCurrentSettingsPath,
        ...
        public static void Update()
        {
            ...
            {
                Current = Default;
                Current.LogRootPath = PathUtility.NormalizePath(
                    Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"/My Games/Crossout/logs");
        ...
        private static void GetMyInfo(out string name, out int userId)
        {
            ...
            try
            {
                using var fs = new FileStream(Path.Combine(GetLatestLog().Path, Strings.GameLogName), FileMode.Open,
