...
namespace CrossoutLogView.Statistics
{
    public class WeaponGlobal : WeaponBase, IStatisticData, IMergable<WeaponGlobal>
    {
        ...
        {
            for (var i = 0; i < other.Users.Count; i++)
            {
        ...
        {
            return string.Concat(nameof(WeaponGlobal), " ", Name, " ", ArmorDamage + CriticalDamage, " ", Users?.Count);
        }
